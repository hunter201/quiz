...
public class Level_3 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        dialog_bg.setBackgroundResource(R.drawable.preview_background_three);
        //set dialog background -- start

        //set description -- start
        TextView textDesc = (TextView) dialog.findViewById(R.id.text_description);
        textDesc.setText(R.string.level_three);
        //set description -- end
        ...
        dialogEndBg.setBackgroundResource(R.drawable.preview_background_three);
        //set bg dialogEnd --start
