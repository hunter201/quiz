...
public class Level_4 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //set bg dialog window -- start
        ImageView background = (ImageView)findViewById(R.id.main_background);
        background.setImageResource(R.drawable.level3_bg);
        //set bg dialog window -- end
        ...
        //set image in dialog window -- start
        ImageView previewImg = (ImageView) dialog.findViewById(R.id.preview_img);
        previewImg.setImageResource(R.drawable.preview_img_fourth);
        //set image in dialog window - end

        //set dialog background -- start
        LinearLayout dialog_bg = (LinearLayout)dialog.findViewById(R.id.dialog_image);
        dialog_bg.setBackgroundResource(R.drawable.preview_background_fourth);
        //set dialog background -- start

        //set description -- start
        TextView textDesc = (TextView) dialog.findViewById(R.id.text_description);
        textDesc.setText(R.string.level_four);
        //set description -- end
        ...
        //set bg dialogEnd --start
        LinearLayout dialogEndBg = (LinearLayout)dialogEnd.findViewById(R.id.dialog_image);
        dialogEndBg.setBackgroundResource(R.drawable.preview_img_three);
        //set bg dialogEnd --start

        //Interesting fact -start
        TextView textDescEnd = (TextView) dialogEnd.findViewById(R.id.text_description_end);
        textDescEnd.setText(R.string.level_three_end);
        ...
        btn_continue2.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                try
                {
                    Intent intent = new Intent(Level_4.this, Level_4.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e)
                {
